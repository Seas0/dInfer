...
parallel='dp' # 'tp' for tensor parallel or 'dp' for data parallel
output_dir='./res' # your customer output path
model_type='llada2' # llada2 (for llada2-mini) | llada_moe (for llada-moe) | llada (for llada or llada-1.5)
